    ...
    public static class Vet
    {
        public static int AddNewCat(string catName)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                {
                    //request.Headers.Accept = new StringContent(catName);
                    request.Content = new StringContent("\""+ catName + "\"");
                    request.Content.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue("application/jason");
